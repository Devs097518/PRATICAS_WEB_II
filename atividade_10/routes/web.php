...
Route::middleware(['auth'])->prefix('admin')->name('librarian.')->group(function () {
    Route::get('/debitos', [DebitController::class, 'index'])->name('debits.index');
    Route::post('/debitos/{user}/zerar', [DebitController::class, 'clear'])->name('debits.clear');
});